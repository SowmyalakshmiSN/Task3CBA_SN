...
{	
	...
	public static void GetUserDetailsCovidGame() throws Exception
	{
		...
		CustomReporter.log("Successfully Captured Response For URL: "+Reusable.getproperty("covid19thegame_Url")+" And Stored In Respective Data Objects");
	...
	{	
		...
		com.cba.coivdgame.API_Regression.DTOs.CovidgameApplication requirements = TestHelper.gsonBuilder ().fromJson(HttpClientHelper.MyPostUrlNN(Reusable.getproperty("covid19thegame_Url"),Reusable.getproperty("covid19thegame_Url_Post_Body1"),null), com.cba.coivdgame.API_Regression.DTOs.CovidgameApplication.class);
		CustomReporter.log("Successfully Captured Response For URL: "+Reusable.getproperty("covid19thegame_Url")+" And Stored In Respective Data Objects");
	...
	public void DeleteUserDetailsCovidGame() throws InterruptedException, IOException 
	{
		...
		CustomReporter.log("Successfully Captured Response For URL: "+Reusable.getproperty("covid19thegame_Url"));
